...
import { ArrowRight, Sparkles, Brain, Shield, Zap, Camera, User, Star, Trophy } from 'lucide-react';

// R-16: Kein eingebetteter OnboardingWizard mehr. Früher öffnete "Mio einrichten"
// einen internen Wizard, dessen "X" auf dieses Intro zurückwarf → Nutzer saß in einer
// Schleife fest. Jetzt startet "Mio einrichten" den vom AppLayout gesteuerten Wizard
// (dessen Schließen führt ins Dashboard), und "Später einrichten" schließt komplett.
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden animate-in fade-in zoom-in-95">
        ...
        <div className="p-6 pt-0 space-y-3">
          ...
          >
            Später einrichten – direkt zum Dashboard
          </button>
        </div>
      </div>
    </div>
